...
if (!headers_sent() && !isset($_REQUEST['down']))
{
...
function smf_main()
{
	...
	$actionArray = array(
		...
		'gdpr' => array('gdpr2.php', 'gdpr_Main'),

		'gallery' => array('Gallery2.php', 'GalleryMain'),
		'adpro' => array('adseller2.php', 'AdsellerMain'),
		...
		'newspro' => array('NewsPro2.php', 'NewsProMain'),
		...
		'register' => array('Register.php', 'Do404Error'),
		'register2' => array('Register.php', 'Do404Error'),
		'join' => array('Register.php', 'Register'),
		'join2' => array('Register.php', 'Register2'),
		...
		'sticky' => array('LockTopic.php', 'Sticky'),		'store' => array('Store2.php', 'StoreMain'),
...
'hacks' => array('Hacks.php', 'HacksMain'),
'monetize' => array('Monetize.php', 'Monetize'),
'modtracker'   => array('ModTracker.php', 'ModTracker'),
'license' => array('License.php', 'LicenseMain'),
'showcase'=> array('Showcase.php', 'ShowcaseMain'),
'themegen' => array('ThemeGen.php', 'ThemeGen'),
'style' => array('styles.php', 'StylesMain'),
'products' => array('Products.php', 'Products'),
	);
