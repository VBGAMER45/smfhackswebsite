...
$helptxt['down_credit_package_currency'] = 'Default currency used for the downloads credit system. All prices in the downloads system are displayed using this currency.';
$helptxt['down_credit_paypal_sandbox'] = 'Enables PayPal sandbox that allows you to do testing with download credit system using testing PayPal money. You need to signup and create a PayPal sandbox account to use this feature.';
$helptxt['down_credit_paypal_secure_disable'] = 'Disables security checking of the price match of the passed price to PayPal compared with the download system. This would be needed if you have custom price/tax settings in PayPal';

$helptxt['down_who_viewing'] = 'Allows members to see who is currently browsing a download category and viewing a download';
$helptxt['down_set_count_child'] = 'Counts one level deep for subcategories for download totals. Required to show the subcategories underneath a category on the board index';
$helptxt['down_set_enable_multifolder'] = 'Allow downloads to be stored in multiple folders instead of just the default folder. Useful for large download sites that have thousands of downloads';
$helptxt['down_set_member_color_link'] = 'Shows all areas using the member\'s primary group link when their member name is displayed';
$helptxt['down_allow_file_uploads'] = 'Allow remotely linked files/pages. With this feature we are unable to determine the filesize of the file since it can be a page that links to a file as well';
$helptxt['downloads_set_custom_name'] = 'This setting allows the option to set a custom name for the download system';
$helptxt['downloads_set_filesize'] = 'Max file that can be uploaded using the download system in bytes';
$helptxt['down_index_showtop'] = 'This setting controls whether the most recent,viewed,comment,rated are displayed on the top of the main index page or the bottom';
$helptxt['down_commentchoice'] = 'Allows the uploader to decide whether they want comments to appear on their download or not.';
$helptxt['down_show_ratings'] = 'Controls whether the rating information is display on the view download page or not';
$helptxt['down_set_show_quickreply'] = 'Shows the quick reply option on the view download page. Does not have bbc editor like the full add comment page.';
$helptxt['down_set_commentsnewest'] = 'This setting controls the display order of the comments on the view download page';

$helptxt['screenshot_set_water_textfont'] = 'The font file used for the text watermark. If you want to use a custom font, the font needs to be placed inside the downloads/font folder';
...
$helptxt['image_proxy_maxsize'] = 'Maximum image size that the image proxy will cache: bigger images will be not be cached. Cached images are stored in your SMF cache folder, so make sure you have enough free space.';//ILA in line attachment changes
