...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '>
	...
	<body>
		...
		<dl id="posts">';
// Begin Ad Seller Pro Location - Top Print Topic

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(14);
if ($adSellerAdData != false)
{
	echo $adSellerAdData;
}

// End Ad Seller Pro Location - Top Print Topic
...
// Begin Ad Seller Pro Location - Bottom Print Topic

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(15);
if ($adSellerAdData != false)
{
	echo $adSellerAdData;
}

// End Ad Seller Pro Location - Bottom Print Topic
