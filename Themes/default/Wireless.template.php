...
// Begin Ad Seller Pro Location - Top WAP page

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(18);
...
// End Ad Seller Pro Location - Top WAP page
...
// Begin Ad Seller Pro Location - Bottom WAP page

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(19);
if ($adSellerAdData != false)
{
	echo '<p>';
	echo $adSellerAdData;
...
// End Ad Seller Pro Location - Bottom WAP page
...
<html', $context['right_to_left'] ? ' dir="rtl"' : '', '>
	...
	<body>';
// Begin Ad Seller Pro Location - Top IMODE page

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(16);
if ($adSellerAdData != false)
{
	echo $adSellerAdData;
}

// End Ad Seller Pro Location - Top IMODE page
...
// Begin Ad Seller Pro Location - Bottom IMODE page

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(17);
if ($adSellerAdData != false)
{
	echo $adSellerAdData;
}

// End Ad Seller Pro Location - Bottom IMODE page
...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '>
	...
	<body>';
// Begin Ad Seller Pro Location - Top WAP2 page

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(20);
if ($adSellerAdData != false)
{
	echo '<p>';
	echo $adSellerAdData;
...
// End Ad Seller Pro Location - Top WAP2 page
...
// Begin Ad Seller Pro Location - Bottom WAP2 page

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(21);
if ($adSellerAdData != false)
{
	echo '<p>';
	echo $adSellerAdData;
...
// End Ad Seller Pro Location - Bottom WAP2 page
