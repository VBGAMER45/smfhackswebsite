...
function template_email_members()
{
	...
	// Show Lists
		...
		echo '</dd>
		<dt>
		<label for="selectlist">' . $txt['newspro_txt_load_saved_list'] . '</label>
		</dt>
		<dd>
	...
	echo '
	<dt>
	<label for="selectmessage">' . $txt['newspro_txt_load_saved_message'] . '</label>
	</dt>
	<dd>
...
function template_email_members_compose()
{
			...
			<div class="windowbg">
				...
				<div class="content">
					...
					<ul class="reset">
						...
						<li><label for="send_html"><input type="checkbox" name="send_html" id="send_html" checked="checked" class="input_check" onclick="this.form.parse_html.disabled = !this.checked;" /> ', $txt['email_as_html'], '<br /><b>',$txt['newspro_html_check'],'</label></li>
	...
	<input type="hidden" name="newspro_list" value="', $context['newspro_list'], '" />
...
function template_email_members_send()
{
	...
	<input type="hidden" name="IDLETTER" value="', $context['ID_LETTER'], '" />
	<input type="hidden" name="ID_LIST" value="', $context['ID_LIST'], '" />
	<input type="hidden" name="tableid" value="', $context['list_tableid'], '" />';
