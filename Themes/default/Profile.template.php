...
// Start gdpr Helper
global $sourcedir;
require_once($sourcedir . '/gdpr2.php');
GDPR_DisplayProfileFields($context['member']['id']);
...
<div class="clear"></div>
	...
	{
		if (allowedTo('apr_rate'))
		{
			echo '<div class="cat_bar">
				<h3 class="catbg">
					<span class="ie6_header floatleft">',$txt['awepost_text_postratings'],'</span>
				</h3>
			</div>
		...
		<div class="windowbg2"><table align="center" width="50%">
					...
					<tr class="titlebg">
						<td>&nbsp;</td>
						<td>',$txt['awepost_text_recieved'],'</td>
						<td>',$txt['awepost_text_given'],'</td>
					</tr>
		';
			...
			Awesome_LoadRatingTypes();
			Awesome_LoadProflieBox($context['member']['id']);


			foreach($context['awe_ratingpostslist'] as $ratingtype)
			{
				echo '<tr>';
				
				echo '<td>';
				echo '<img src="' . $modSettings['apr_url'] . $ratingtype['icon'] . '" alt="' . $ratingtype['title'] . '" />';
				echo '</td>';
				...
				foreach($context['awe_ratingsrecieved'] as $memrec)
				{
					if ($ratingtype['id_ratetype'] == $memrec['id_ratetype'])
						$totalRec =  $memrec['total'];
				...
				$totalGive = 0;
				foreach($context['awe_ratingsgiven'] as $memgive)
				{
					if ($ratingtype['id_ratetype'] == $memgive['id_ratetype'])
						$totalGive =  $memgive['total'];
				}
