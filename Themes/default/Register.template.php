...
if (!empty($modSettings['gdpr_enable_privacy_policy']))
{
		echo '
			<div class="title_bar">
				<h4 class="titlebg">', $txt['gdpr_txt_privacy_header'], '</h4>
			</div>
			<div class="windowbg2">
				<span class="topslice"><span></span></span>
				' . $txt['gdpr_txt_privacy_desc'] . '
				<br />
				<dl>
					<dt class="register_form"><strong><label for="privacy_agree">', $txt['gdpr_txt_privacy_agree'], ':</label></strong></dt>
						<dd>
