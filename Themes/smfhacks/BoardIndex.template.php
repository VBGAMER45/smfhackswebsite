...
// Begin Ad Seller Pro Location - Board Index Top

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(11);
if ($adSellerAdData != false)
{
	echo $adSellerAdData;
}

// End Ad Seller Pro Location - Board Index Top
		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				<tr id="board_', $board['id'], '" class="windowbg4">
					<td class="icon" style="height:70px;">
				...
				if (!empty($board['children']))
				{
					...
					echo '
					<p id="board_', $board['id'], '_children" class="moderators">
...
// Begin Ad Seller Pro Location - Board Index Bottom

global $sourcedir;
include_once $sourcedir . "/adseller2.php";

$adSellerAdData =  ShowAdLocation(12);
if ($adSellerAdData != false)
{
	echo $adSellerAdData;
}

// End Ad Seller Pro Location - Board Index Bottom

// Here's where the "Info Center" starts...
	echo '
	<div id="icenter" class="clear">
		<div class="cat_bar">
			<h3 class="catbg">
	...
	if (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post'])))
	{
		echo '
			...
			<div class="hslice icenterbg" id="recent_posts_content">
