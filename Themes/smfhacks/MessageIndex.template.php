	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		...
		foreach ($context['boards'] as $board)
		{
			...
			if (!empty($board['children']))
			{
				...
				echo '
				<p id="board_', $board['id'], '_children" class="children"><strong>', $txt['parent_boards'], '</strong>: ', implode(', ', $children), '</p>';
			}
...
// Begin Ad Seller Pro Location - Top Message Index
...
// End Ad Seller Pro Location - Top Message Index
